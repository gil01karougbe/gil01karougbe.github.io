...
## Kill Chain Summary
1. Exploit CVE-2021-43798 to gain file read capabilities on the box.
2. Read the Grafana database.
3. Use grafana2hashcat and hashcat to crack the Grafana database password entries.
4. boris is allowed to run `/snap/bin/docker exec *` as root without a password.
5. Use the docker exec command to abuse the Grafana container and escalate to root.
