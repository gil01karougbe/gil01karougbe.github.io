...
Emily is member of Remote Management Users and Backup Operators Groups...We can connect over winrm using evil-winrm tool. (By the time writting this i've notice i didn't take a screenshot when i was pwning the box...)
```bash
